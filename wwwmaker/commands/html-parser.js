...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c9 = function(attrs, c) { c },
      peg$c10 = function(attrs, ch) { return ch.join('') },
      peg$c11 = function(attrs, content) { return new Node('script', attrs, content); },
      peg$c12 = peg$otherExpectation("style"),
      peg$c13 = "<style",
      peg$c14 = peg$literalExpectation("<style", true),
      peg$c15 = "</style",
      peg$c16 = peg$literalExpectation("</style", true),
      peg$c17 = function(attrs, content) { return new Node('style', attrs, content); },
      ...
      peg$c23 = function(attrs, content) { return new Node('textarea', attrs, content); },
      peg$c24 = peg$otherExpectation("title"),
      peg$c25 = "<title",
      peg$c26 = peg$literalExpectation("<title", true),
      peg$c27 = "</title",
      peg$c28 = peg$literalExpectation("</title", true),
      peg$c29 = function(attrs, content) { return new Node('title', attrs, content); },
      ...
      peg$c35 = function(attrs, content) { return new Node('plaintext', attrs, content); },
      peg$c36 = peg$otherExpectation("element"),
      peg$c37 = function(begin, content, end) { return begin.name == end },
      peg$c38 = function(begin, content, end) {
      ...
      peg$c42 = function(name, attrs) { return new Node(name.toLowerCase(), attrs); },
      ...
      peg$c49 = function(name, attrs) { return new Node(name, attrs); },
      ...
      peg$c55 = function(text) {
          return new Node('comment', null, text);
        },
      ...
      peg$c65 = function(root, type, text) {
          const node = new Node('doctype');
      ...
      peg$c70 = function(ch) {
          return new Node('text', null,ch.join(''));
        },
      peg$c71 = function(c) { c },
      peg$c72 = function(ch) {
          return new Node('text', null, ch.join(''));
        },
      peg$c73 = function(attrs) { return (attrs && attrs.length) ? reduceToObj(attrs) : null;},
      peg$c74 = peg$otherExpectation("attribute"),
      peg$c75 = "=",
      peg$c76 = peg$literalExpectation("=", false),
      peg$c77 = function(name, s) { return s },
      peg$c78 = function(name, text) { return {name:name, text:text}; },
      peg$c79 = /^[^> ]/,
      ...
      peg$c87 = function(ch) { return ch.join(''); },
      peg$c88 = "'",
      ...
      peg$c98 = function(h, t) { return h + t.join('') },
      peg$c99 = peg$otherExpectation("space characters"),
      peg$c100 = /^[\r\n \t\f]/,
